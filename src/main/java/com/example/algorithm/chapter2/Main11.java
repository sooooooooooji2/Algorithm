...
public class Main11 {
    ...
    private static int solution(int n , int[][] arr){
        int result = 0, max = 0;
        for(int i = 1 ; i < n+1 ; i++){ // i번째 학생
            int cnt = 0;
            for(int j = 1 ; j < n+1; j++) { // j번째 학생
...
// 위 경우에 4번 학생을 보면 3번 학생과 2학년 때 같은 반이었고, 3번 학생 및 5번 학생과 3학 년 때 같은 반이었으며, 2번 학생과는 4학년 때 같은 반이었음을 알 수 있다.
